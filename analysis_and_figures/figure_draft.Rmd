...
knitr::include_graphics("./publication_ready_figure/supplemental_figures/figure1_v3.png")
```
...
```{r Suppl_Fig_2, fig.height=10, fig.width=14}
...
s3a <- ggplot(rec_trans, aes(x = expected_conc, y = Concentration)) + 
  ...
  geom_text_repel(
    data = rec_trans %>% 
      ...
      select(Method, Target, Concentration, expected_conc) %>% 
      distinct(), 
    aes(label = Target), 
    size = 2.3, 
    alpha = .5
