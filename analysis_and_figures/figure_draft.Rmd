...
f2a <- ggplot(domain_plot, aes(x = Sample, y = Percent_fragments, fill = Tax_name, alpha = Tax_name)) +
  geom_bar(stat = "identity", color = "black", width = 1, position = "fill", alpha = 0.8) +
  theme_bw() + 
  ...
  guides(alpha = "none", fill = guide_legend(override.aes = list(alpha = 0.8)))
...
(sf2a / sf2b / sf2c) + plot_layout(heights = c(4,1,1)) + plot_annotation(tag_levels = "A") 
```
...
```{r Suppl_Fig_8, fig.height=4, fig.width=14}
