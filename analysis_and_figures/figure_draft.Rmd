...
ggsave(s7, filename = "/home/mthomt69/personal_folder_BACKUP/gitlab/wwdv_manuscript/analysis/publication_ready_figure/supplement_figures/n_missing_taxa.png",
       height = 4,
       width = 14,
       units = "in"
       )
...
#ggsave(plot= char, filename = "./analysis/exploratory_analysis/final_plots/characteristics_plotted.png", height = 12, width = 12)
